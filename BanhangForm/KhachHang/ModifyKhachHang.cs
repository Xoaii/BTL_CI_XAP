       ...
       public DataTable getAllKhachhang()
        ...
        public bool Update(QLkhachHang qLkhachHang)
        {
            ...
            try
            {
                sqlConnection.Open();
                sqlCommand = new SqlCommand(query, sqlConnection);
                sqlCommand.Parameters.Add("@mahang", SqlDbType.NVarChar).Value = qLkhachHang.MaKhachHang;
                sqlCommand.Parameters.Add("@tenhang", SqlDbType.NVarChar).Value = qLkhachHang.TenCongTy1;
                sqlCommand.Parameters.Add("@macongty", SqlDbType.NVarChar).Value = qLkhachHang.TenGiaoDich;
                sqlCommand.Parameters.Add("@maloaihang", SqlDbType.NVarChar).Value = qLkhachHang.TenGiaoDich;
                sqlCommand.Parameters.Add("@soluong", SqlDbType.NVarChar).Value = qLkhachHang.DiaChi;
                sqlCommand.Parameters.Add("@donvitinh", SqlDbType.NVarChar).Value = qLkhachHang.Email;
                sqlCommand.Parameters.Add("@giahang", SqlDbType.NVarChar).Value = qLkhachHang.DienThoai;
                sqlCommand.Parameters.Add("@giahang", SqlDbType.NVarChar).Value = qLkhachHang.Fax;
                sqlCommand.Parameters.Add("@giahang", SqlDbType.NVarChar).Value = qLkhachHang.TenKhachHang;
                sqlCommand.ExecuteNonQuery();//thực thi lệnh truy vấn
            }
            catch
            {
